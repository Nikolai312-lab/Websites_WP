...
/**
 * Title: Our Services 
 * Slug: one-business-blocks/our-services
 * Categories: one-business-blocks, our-services
 */
?>
...
<!-- wp:columns {"verticalAlignment":"center","className":"service-outer-box","style":{"spacing":{"blockGap":{"left":"60px"}}}} -->
<div class="wp-block-columns are-vertically-aligned-center service-outer-box"><!-- wp:column {"verticalAlignment":"center","width":"25%","className":"service-box wow swing"} -->
<div class="wp-block-column is-vertically-aligned-center service-box wow swing" style="flex-basis:25%"><!-- wp:group {"className":"service-inner-box","style":{"spacing":{"padding":{"top":"20px","bottom":"20px","left":"15px","right":"15px"}}},"backgroundColor":"section-bg","layout":{"type":"constrained"}} -->
<div class="wp-block-group service-inner-box has-section-bg-background-color has-background" style="padding-top:20px;padding-right:15px;padding-bottom:20px;padding-left:15px"><!-- wp:image {"id":157,"sizeSlug":"full","linkDestination":"none","align":"center"} -->
...
<p class="has-text-align-center"><?php esc_html_e('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor','one-business-blocks'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->

<!-- wp:column {"verticalAlignment":"center","width":"25%","className":"service-box wow swing"} -->
<div class="wp-block-column is-vertically-aligned-center service-box wow swing" style="flex-basis:25%"><!-- wp:group {"className":"service-inner-box","style":{"spacing":{"padding":{"top":"20px","bottom":"20px","left":"15px","right":"15px"}}},"backgroundColor":"section-bg","layout":{"type":"constrained"}} -->
<div class="wp-block-group service-inner-box has-section-bg-background-color has-background" style="padding-top:20px;padding-right:15px;padding-bottom:20px;padding-left:15px"><!-- wp:image {"id":158,"sizeSlug":"full","linkDestination":"none","align":"center"} -->
...
<!-- wp:column {"verticalAlignment":"center","width":"25%","className":"service-box wow swing"} -->
<div class="wp-block-column is-vertically-aligned-center service-box wow swing" style="flex-basis:25%"><!-- wp:group {"className":"service-inner-box","style":{"spacing":{"padding":{"top":"20px","bottom":"20px","left":"15px","right":"15px"}}},"backgroundColor":"section-bg","layout":{"type":"constrained"}} -->
<div class="wp-block-group service-inner-box has-section-bg-background-color has-background" style="padding-top:20px;padding-right:15px;padding-bottom:20px;padding-left:15px"><!-- wp:image {"id":155,"sizeSlug":"full","linkDestination":"none","align":"center"} -->
...
<!-- wp:column {"verticalAlignment":"center","width":"25%","className":"service-box wow swing"} -->
<div class="wp-block-column is-vertically-aligned-center service-box wow swing" style="flex-basis:25%"><!-- wp:group {"className":"service-inner-box","style":{"spacing":{"padding":{"top":"20px","bottom":"20px","left":"15px","right":"15px"}}},"backgroundColor":"section-bg","layout":{"type":"constrained"}} -->
<div class="wp-block-group service-inner-box has-section-bg-background-color has-background" style="padding-top:20px;padding-right:15px;padding-bottom:20px;padding-left:15px"><!-- wp:image {"id":156,"sizeSlug":"full","linkDestination":"none","align":"center"} -->
